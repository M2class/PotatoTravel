...
//    注册按钮
    ...
    _passwdtext.autocapitalizationType = UITextAutocapitalizationTypeNone;
...
//   链接登录接口
    [AsyConnecModel connectionWithUrl:RS_TripConnection parmaters:dic finishBlock:^(id response){
...
//        单例
        ...
        if ([response isKindOfClass:[NSDictionary class]] ) {
            ...
            else
            {
                ...
                UIAlertView * erroralert = [[UIAlertView alloc] initWithTitle:myerror message:nil
